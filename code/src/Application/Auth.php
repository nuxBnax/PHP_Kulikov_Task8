...
class Auth
{
    ...
    // RestoreSession
    // если есть Куки и нет Сессии то вызвать UserVerify token  и поместить туда это действие
    ...
    {
        // находит пользователя и если он есть и пароль соответствует то вернет true
    ...
    // дописать метод генерйт токен указать 16 байт
}