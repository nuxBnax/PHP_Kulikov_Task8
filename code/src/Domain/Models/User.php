...
class User
{
    ...
    public static function validateRequestData(): bool
    {
        ...
        // добавить раздевание <>
        print_r($result ? "true - после первичной валидации" : "false - после первичной валидации");
        echo '<br>';
        ...
        var_dump($result);
        echo '<br>';
        print_r($result ? "true - в самом конце" : "false - в самом конце");
        return $result;
    }
    ...
    // сделать метод SetToken и он должен обновить токен в базе данных, делается UPDATE в базу, и в Куки на неделю

    // каждый раз когда мы входим должна проверяться Куки при заходе на сайт и заодно проверятся Сессия и тогда делать 
    // процедуру proceedAuth в Auth Это будет в Application сразу после session_start, написать отдельный метод RestoreSession
    // главное проверить Куки и сессию на 28 строке в Application
}